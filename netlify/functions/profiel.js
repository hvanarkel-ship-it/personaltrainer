...
export const handler = async (event) => {
  ...
  try {
    ...
    if (event.httpMethod === 'PUT') {
      ...
      await sql`
        INSERT INTO user_profile (user_id, geboortejaar, lengte_cm, gewicht_kg,
          doel_kcal, doel_eiwit_g, doel_koolhydraten_g, doel_vetten_g, sporten)
        VALUES (${userId}, ${d.geboortejaar||null}, ${d.lengte_cm||null}, ${d.gewicht_kg||null},
          ${d.doel_kcal||2400}, ${d.doel_eiwit_g||160}, ${d.doel_koolhydraten_g||250},
          ${d.doel_vetten_g||80}, ${d.sporten||['fitness','padel','fietsen']})
