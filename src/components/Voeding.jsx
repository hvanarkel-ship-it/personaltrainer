                ...
                {TYPES.map(t => (
                  <button
                    ...
                    style={{
                      ...
                      border: form.maaltijd_type === t ? '1px solid var(--border-active)' : '1px solid transparent',
              ...
              {TYPES.map(t => (
                <button
                  ...
                  style={{
                    ...
                    border: editForm.maaltijd_type === t ? '1px solid var(--border-active)' : '1px solid transparent',
                    borderRadius: 'var(--r-xs)', cursor: 'pointer',
